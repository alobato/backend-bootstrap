...
export function getBookAuthors(req: Request, res: Response) {
...
export function getBookCategories(req: Request, res: Response) {
  const bookId = Number(req.params.id);
  if (Number.isNaN(bookId)) {
    return res.status(400).json({ error: "ID inválido" });
  }
...
export function addAuthorsToBook(req: Request, res: Response) {
...
export function removeAuthorsFromBook(req: Request, res: Response) {
...
export function addCategoriesToBook(req: Request, res: Response) {
...
export function removeCategoriesFromBook(req: Request, res: Response) {
